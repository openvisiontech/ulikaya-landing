...
import { Bot, Cpu, Navigation, Eye, Waves, Wrench, Radio, Volume2, ShieldAlert, Zap, Cpu as Board, Wifi, Battery, Camera, Disc, MonitorSpeaker, Compass, Activity, Truck, ChevronRight, Network } from 'lucide-react';
                ...
                <div className="lg:w-1/3">
                    <div className="sticky top-32">
                        ...
                        <div className="p-6 bg-white/5 border border-white/10 rounded-2xl backdrop-blur-sm">
                            ...
                            <p className="text-sm text-gray-400 mb-6 font-light">Email: genshianglin@gmail.com to request a kit quote.</p>
                            <a
                                href="mailto:genshianglin@gmail.com"
                                className="w-full py-3 bg-accent hover:bg-orange-500 rounded-xl font-bold flex items-center justify-center gap-2 transition-all shadow-lg shadow-accent/20"
                            >
                                Contact for Kit
                            </a>
                        </div>
